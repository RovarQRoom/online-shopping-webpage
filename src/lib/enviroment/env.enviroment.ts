...
export const appwrite_collection_category = ENVIROMENT.VITE_APPWRITE_CATEGORY_ID;
export const appwrite_collection_item = ENVIROMENT.VITE_APPWRITE_ITEM_ID;
export const appwrite_collection_favorite = ENVIROMENT.VITE_APPWRITE_FAVORITE_ID;
